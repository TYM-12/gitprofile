...
const CONFIG = {
  scratch: {
    ...
    limit: 5, // How many projects to display; maximum 20
    sortBy: 'date', // date | views | remixes
    corsProxy: 'https://api.allorigins.win/raw?url=', //TODO: Enter your CORS Proxy here
  },
  github: {
    username: 'TYM-12', // Your GitHub org/user name. (This is the only required config)
  },
  base: '/gitprofile',
  projects: {
    github: {
